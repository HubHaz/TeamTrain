...
public class RegisterClientCommandHandler(IAuthClientService authService) : IRequestHandler<RegisterClientCommand, ServiceResponse<AuthClientResult>>
{
    public async Task<ServiceResponse<AuthClientResult>> Handle(RegisterClientCommand request, CancellationToken cancellationToken)
    {
